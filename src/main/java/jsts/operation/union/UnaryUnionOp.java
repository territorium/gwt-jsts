...
public class UnaryUnionOp {
	...
	@JsConstructor
	public UnaryUnionOp(Collection<Geometry> geoms) {}

	@JsConstructor
	public UnaryUnionOp(Collection<Geometry> geoms, GeometryFactory geomFact) {};

	@JsConstructor
	public UnaryUnionOp(Geometry geom) {};

	public native Geometry union();
}
