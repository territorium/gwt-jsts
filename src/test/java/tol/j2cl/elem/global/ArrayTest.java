 ...
 * @version 4.0,09.03.2017
 * @since 4.0.
 */
public class ArrayTest extends GwtJSTSTestCase {

	@Test
	public void testCreateArray() {
		final Array<Coordinate> coords = new Array<Coordinate>();
		coords.push(new Coordinate(260, 250));
		coords.push(new Coordinate(810, 250));
		coords.push(new Coordinate(810, 50));

		assertTrue(coords.getLength() == 3);
